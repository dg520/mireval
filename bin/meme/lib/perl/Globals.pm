...
our $SITE_MAINTAINER = '@eris1n2.research.partners.org';
our $SITE_URL = 'http://meme-suite.org/';
our $MEME_DIR = '/apps/lab/miket/miREval/2.0/mireval/bin/meme';
our $MEME_LOGS = '/apps/lab/miket/miREval/2.0/mireval/bin/meme/LOGS';
our $MEME_DB = '/apps/lab/miket/miREval/2.0/mireval/bin/meme/db';
our $MEME_BIN = '/apps/lab/miket/miREval/2.0/mireval/bin/meme/bin';
our $MEME_WEB = '/apps/lab/miket/miREval/2.0/mireval/bin/meme/web';
our $MAXTIME = '18000';
